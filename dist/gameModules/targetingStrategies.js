...
exports.getNearestEnemy = getNearestEnemy;
exports.getEnemyWithMostHealth = getEnemyWithMostHealth;
exports.getEnemyWithLeastHealth = getEnemyWithLeastHealth;
exports.getEnemyClosestToExit = getEnemyClosestToExit;
/**
 ...
 */
function getNearestEnemy(enemies, towerX, towerY, range) {
    let nearest = null;
 ...
 */
function getEnemyWithMostHealth(enemies, towerX, towerY, range) {
    let target = null;
 ...
 */
function getEnemyWithLeastHealth(enemies, towerX, towerY, range) {
    let target = null;
 ...
 */
function getEnemyClosestToExit(enemies, towerX, towerY, range) {
    let target = null;
